...
echo "<table>";
echo "<tr>";
echo "<td>(px)</td><td>mask awal</td><td>probabilitas</td><td>mask akhir</td>";
echo "</tr>";
echo "<tr>";
echo "<td>".$px."</td><td>".implode(' ',$mask)."</td><td>".implode('/',$prob)."</td><td>".implode(' ',$new_mask)."</td>";
echo "</tr>";
echo "</table>";
$x1 = $l[0];
$x2 = $l[1];
