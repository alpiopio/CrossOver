...
$r1 = 0;
$r2 = 0;
while($r1 == $r2 or $r2 < $r1){
	$r1 = mt_rand(1,$panjang_bit);
	$r2 = mt_rand(1,$panjang_bit);
}
...
echo "BIT BINARY CROMOSOM (r1 = ".$r1." & r2 = ".$r2.")";
echo "<table>";
echo "<tr>";
...
echo "</tr>";
echo "<tr>";
echo "<td>".$r1." & ".$r2."</td><td>".implode(' ',$mask)."</td><td>".implode(' ',$new_mask)."</td>";
echo "</tr>";
echo "</table>";
$x1 = $l[0];
$x2 = $l[1];
